    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
      <div class="flex items-center justify-between md:justify-evenly gap-3">
        <div>
          ...
          <div class="text-2xl sm:text-3xl font-bold">10</div>
        </div>
      ...
      <div class="flex items-center justify-between md:justify-evenly gap-3">
        ...
        <div class="bg-lime-100 text-yellow-600 p-3 rounded-xl md:p-4 md:rounded-2x text-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div class="flex items-center justify-between md:justify-evenly gap-3">
        ...
        <div class="bg-violet-100 text-purple-600 p-3 rounded-xl md:p-4 md:rounded-2x text-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div class="flex items-center justify-between md:justify-evenly gap-3">
        ...
        <div class="bg-green-100 text-emerald-600 p-3 rounded-xl md:p-4 md:rounded-2x text-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
